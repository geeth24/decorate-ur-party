...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn("transition-bg flex h-[calc(100vh-64px)] flex-col items-center justify-center", className)}
        {...props}
      >
        <div className="absolute inset-0 overflow-hidden">
          <div
            ...
            blur-[10px]
            invert
            filter will-change-transform [--aurora:repeating-linear-gradient(100deg,hsl(var(--primary))_10%,hsl(var(--secondary))_15%,hsl(var(--primary))_20%,var(--violet-200)_25%,hsl(var(--primary))_30%)] [--dark-gradient:repeating-linear-gradient(100deg,var(--black)_0%,var(--black)_7%,var(--transparent)_10%,var(--transparent)_12%,var(--black)_16%)]
